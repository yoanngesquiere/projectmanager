...
use ProjectManager\Bundle\PeopleBundle\Form\TeamType;
...
class TeamController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('ProjectManagerPeopleBundle:Team')->findAll();
     ...
     * @Method("POST")
     * @Template("ProjectManagerPeopleBundle:Team:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('ProjectManagerPeopleBundle:Team')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("ProjectManagerPeopleBundle:Team:edit.html.twig")
     */
